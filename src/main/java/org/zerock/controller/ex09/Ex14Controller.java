...
public class Ex14Controller {
	...
	public void method02(int id, Model model) {
		String firstName = service.getNameByFirstName(id);
	...
	// ex14/sub04?id=7
	// 직원의 FirstName, LastName이 모두 jsp에 출력되도록 
	...
	@PostMapping("sub06")
	public String method(EmployeeDto employee, RedirectAttributes rttr) {
		
		boolean ok = service.addEmployees(employee);
